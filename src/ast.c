...
void (*const ast_node_free[AST_NODES_TOTAL])(ast_t *ast) = {
	...
	ast_declaration_free,
	ast_declaration_list_free,
...
void (*const fprint_ast_node[AST_NODES_TOTAL])(
	...
	fprint_ast_declaration,
	fprint_ast_declaration_list,
