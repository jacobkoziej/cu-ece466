...
void (*const ast_node_free[AST_NODES_TOTAL])(ast_t *ast) = {
	...
	[AST_TRANSLATION_UNIT]         = ast_translation_unit_free,
...
void (*const fprint_ast_node[AST_NODES_TOTAL])(
	...
	[AST_CONTINUE]                 = fprint_ast_continue,
	...
	[AST_TRANSLATION_UNIT]         = fprint_ast_translation_unit,
...
const char *const ast_node_str[AST_NODES_TOTAL] = {
	...
	[AST_TRANSLATION_UNIT]         = "translation-unit",
	[AST_TYPE]                     = "type",
