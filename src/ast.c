...
void (*const ast_node_free[AST_NODES_TOTAL])(ast_t *ast) = {
	...
	[AST_ARGUMENT_LIST]            = ast_argument_list_free,
	...
	[AST_DECLARATION_LIST]         = ast_declaration_list_free,
	...
	[AST_IDENTIFIER_LIST]          = ast_identifier_list_free,
	...
	[AST_TYPE_NAME]                = ast_type_name_free,
...
void (*const fprint_ast_node[AST_NODES_TOTAL])(
	...
	[AST_ARGUMENT_LIST]            = fprint_ast_argument_list,
	...
	[AST_DECLARATION_LIST]         = fprint_ast_declaration_list,
	...
	[AST_IDENTIFIER_LIST]          = fprint_ast_identifier_list,
	...
	[AST_TYPE_NAME]                = fprint_ast_type_name,
...
const char *const ast_node_str[AST_NODES_TOTAL] = {
	...
	[AST_ALIGNAS]                  = "alignas",
	[AST_ALIGNOF]                  = "alignof",
	[AST_ARGUMENT_LIST]            = "argument-list",
	[AST_ARRAY]                    = "array",
	...
	[AST_DECLARATION_LIST]         = "declaration-list",
	...
	[AST_IDENTIFIER_LIST]          = "identifier-list",
