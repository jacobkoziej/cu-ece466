...
static void test_character_constants(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), CHARACTER_CONSTANT);
...
static void test_floating_constants(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), FLOATING_CONSTANT);
...
static void test_identifiers(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), IDENTIFIER);
...
static void test_integer_constants(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), INTEGER_CONSTANT);
...
static void test_keywords(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_AUTO);
	assert_string_equal(yyget_text(yyscanner), "auto");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_BREAK);
	assert_string_equal(yyget_text(yyscanner), "break");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_CASE);
	assert_string_equal(yyget_text(yyscanner), "case");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_CHAR);
	assert_string_equal(yyget_text(yyscanner), "char");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_CONST);
	assert_string_equal(yyget_text(yyscanner), "const");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_CONTINUE);
	assert_string_equal(yyget_text(yyscanner), "continue");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_DEFAULT);
	assert_string_equal(yyget_text(yyscanner), "default");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_DO);
	assert_string_equal(yyget_text(yyscanner), "do");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_DOUBLE);
	assert_string_equal(yyget_text(yyscanner), "double");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_ELSE);
	assert_string_equal(yyget_text(yyscanner), "else");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_ENUM);
	assert_string_equal(yyget_text(yyscanner), "enum");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_EXTERN);
	assert_string_equal(yyget_text(yyscanner), "extern");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_FLOAT);
	assert_string_equal(yyget_text(yyscanner), "float");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_FOR);
	assert_string_equal(yyget_text(yyscanner), "for");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_GOTO);
	assert_string_equal(yyget_text(yyscanner), "goto");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_IF);
	assert_string_equal(yyget_text(yyscanner), "if");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_INLINE);
	assert_string_equal(yyget_text(yyscanner), "inline");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_INT);
	assert_string_equal(yyget_text(yyscanner), "int");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_LONG);
	assert_string_equal(yyget_text(yyscanner), "long");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_REGISTER);
	assert_string_equal(yyget_text(yyscanner), "register");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_RESTRICT);
	assert_string_equal(yyget_text(yyscanner), "restrict");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_RETURN);
	assert_string_equal(yyget_text(yyscanner), "return");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_SHORT);
	assert_string_equal(yyget_text(yyscanner), "short");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_SIGNED);
	assert_string_equal(yyget_text(yyscanner), "signed");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_SIZEOF);
	assert_string_equal(yyget_text(yyscanner), "sizeof");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_STATIC);
	assert_string_equal(yyget_text(yyscanner), "static");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_STRUCT);
	assert_string_equal(yyget_text(yyscanner), "struct");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_SWITCH);
	assert_string_equal(yyget_text(yyscanner), "switch");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_TYPEDEF);
	assert_string_equal(yyget_text(yyscanner), "typedef");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_UNION);
	assert_string_equal(yyget_text(yyscanner), "union");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_UNSIGNED);
	assert_string_equal(yyget_text(yyscanner), "unsigned");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_VOID);
	assert_string_equal(yyget_text(yyscanner), "void");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_VOLATILE);
	assert_string_equal(yyget_text(yyscanner), "volatile");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD_WHILE);
	assert_string_equal(yyget_text(yyscanner), "while");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__ALIGNAS);
	assert_string_equal(yyget_text(yyscanner), "_Alignas");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__ALIGNOF);
	assert_string_equal(yyget_text(yyscanner), "_Alignof");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__ATOMIC);
	assert_string_equal(yyget_text(yyscanner), "_Atomic");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__BOOL);
	assert_string_equal(yyget_text(yyscanner), "_Bool");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__COMPLEX);
	assert_string_equal(yyget_text(yyscanner), "_Complex");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__GENERIC);
	assert_string_equal(yyget_text(yyscanner), "_Generic");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__IMAGINARY);
	assert_string_equal(yyget_text(yyscanner), "_Imaginary");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__NORETURN);
	assert_string_equal(yyget_text(yyscanner), "_Noreturn");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__STATIC_ASSERT);
	assert_string_equal(yyget_text(yyscanner), "_Static_Assert");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), KEYWORD__THREAD_LOCAL);
...
static void test_punctuators(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LBRACKET);
	assert_string_equal(yyget_text(yyscanner), "[");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LBRACKET);
	assert_string_equal(yyget_text(yyscanner), "<:");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_RBRACKET);
	assert_string_equal(yyget_text(yyscanner), "]");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_RBRACKET);
	assert_string_equal(yyget_text(yyscanner), ":>");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LPARENTHESIS);
	assert_string_equal(yyget_text(yyscanner), "(");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_RPARENTHESIS);
	assert_string_equal(yyget_text(yyscanner), ")");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LBRACE);
	assert_string_equal(yyget_text(yyscanner), "{");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LBRACE);
	assert_string_equal(yyget_text(yyscanner), "<%");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_RBRACE);
	assert_string_equal(yyget_text(yyscanner), "}");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_RBRACE);
	assert_string_equal(yyget_text(yyscanner), "%>");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_MEMBER_ACCESS);
	assert_string_equal(yyget_text(yyscanner), ".");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_MEMBER_ACCESS_DEREFERENCE);
	assert_string_equal(yyget_text(yyscanner), "->");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_INCREMENT);
	assert_string_equal(yyget_text(yyscanner), "++");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_DECREMENT);
	assert_string_equal(yyget_text(yyscanner), "--");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_AMPERSAND);
	assert_string_equal(yyget_text(yyscanner), "&");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_ASTERISK);
	assert_string_equal(yyget_text(yyscanner), "*");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_PLUS);
	assert_string_equal(yyget_text(yyscanner), "+");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_MINUS);
	assert_string_equal(yyget_text(yyscanner), "-");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_UNARY_COMPLEMENT);
	assert_string_equal(yyget_text(yyscanner), "~");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LOGICAL_NOT);
	assert_string_equal(yyget_text(yyscanner), "!");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_DIVISION);
	assert_string_equal(yyget_text(yyscanner), "/");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_MODULO);
	assert_string_equal(yyget_text(yyscanner), "%");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LBITSHIFT);
	assert_string_equal(yyget_text(yyscanner), "<<");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_RBITSHIFT);
	assert_string_equal(yyget_text(yyscanner), ">>");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LESS_THAN);
	assert_string_equal(yyget_text(yyscanner), "<");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_GREATER_THAN);
	assert_string_equal(yyget_text(yyscanner), ">");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LESS_THAN_OR_EQUAL);
	assert_string_equal(yyget_text(yyscanner), "<=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_GREATER_THAN_OR_EQUAL);
	assert_string_equal(yyget_text(yyscanner), ">=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_EQUALITY);
	assert_string_equal(yyget_text(yyscanner), "==");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_INEQUALITY);
	assert_string_equal(yyget_text(yyscanner), "!=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_XOR);
	assert_string_equal(yyget_text(yyscanner), "^");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_OR);
	assert_string_equal(yyget_text(yyscanner), "|");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LOGICAL_AND);
	assert_string_equal(yyget_text(yyscanner), "&&");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_LOGICAL_OR);
	assert_string_equal(yyget_text(yyscanner), "||");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_CONDITIONAL_QUESTION);
	assert_string_equal(yyget_text(yyscanner), "?");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_CONDITIONAL_COLON);
	assert_string_equal(yyget_text(yyscanner), ":");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_SEMICOLON);
	assert_string_equal(yyget_text(yyscanner), ";");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_VARIADIC);
	assert_string_equal(yyget_text(yyscanner), "...");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_ASSIGNMENT);
	assert_string_equal(yyget_text(yyscanner), "=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_MULTIPLICATION);
	assert_string_equal(yyget_text(yyscanner), "*=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_DIVISION);
	assert_string_equal(yyget_text(yyscanner), "/=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_MODULO);
	assert_string_equal(yyget_text(yyscanner), "%=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_ADDITION);
	assert_string_equal(yyget_text(yyscanner), "+=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_SUBTRACTION);
	assert_string_equal(yyget_text(yyscanner), "-=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_LBITSHIFT);
	assert_string_equal(yyget_text(yyscanner), "<<=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_RBITSHIFT);
	assert_string_equal(yyget_text(yyscanner), ">>=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_AND);
	assert_string_equal(yyget_text(yyscanner), "&=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_XOR);
	assert_string_equal(yyget_text(yyscanner), "^=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMPOUND_OR);
	assert_string_equal(yyget_text(yyscanner), "|=");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_COMMA);
	assert_string_equal(yyget_text(yyscanner), ",");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_PREPROCESSOR);
	assert_string_equal(yyget_text(yyscanner), "#");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_PREPROCESSOR);
	assert_string_equal(yyget_text(yyscanner), "%:");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_PREPROCESSOR_PASTING);
	assert_string_equal(yyget_text(yyscanner), "##");
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), PUNCTUATOR_PREPROCESSOR_PASTING);
	assert_string_equal(yyget_text(yyscanner), "%:%:");
}
...
static void test_string_literals(void **state)
{
	...
	assert_int_equal(yylex(&yylval, &yyloc, yyscanner), STRING_LITERAL);
